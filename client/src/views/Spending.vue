...
.legend-dot.revenue-color { background: var(--accent-yellow); }
.legend-dot.cost-color { background: var(--error); }
...
.category-bar {
  height: 100%;
  background: linear-gradient(90deg, var(--accent-yellow) 0%, var(--accent-yellow-hover) 100%);
  border-radius: 4px;
