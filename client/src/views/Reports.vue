...
.bar {
  width: 100%;
  background: linear-gradient(to top, var(--accent-yellow), var(--accent-yellow-hover));
...
.bar:hover {
  background: linear-gradient(to top, var(--accent-yellow-active), var(--accent-yellow));
}
