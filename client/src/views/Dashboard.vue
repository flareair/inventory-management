              ...
              <div class="order-health-chart">
                <svg viewBox="0 0 200 200" class="donut-svg-compact">
                  ...
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--warning)" stroke-width="25"
                    ...
                    transform="rotate(-90 100 100)"/>
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--error)" stroke-width="25"
                ...
                <div class="donut-legend-compact">
                  ...
                  <div class="legend-item-compact"><span class="legend-dot" style="background: var(--error)"></span>{{ t('status.backordered') }}</div>
                </div>
              </div>
            ...
            <table>
              ...
              <tbody>
                ...
                >
                  ...
                  <td @click="showBacklogDetail(item)" style="cursor: pointer;">
                    <span :style="{ color: item.days_delayed > 7 ? 'var(--error)' : 'var(--warning)', fontWeight: 600 }">
...
export default {
  ...
  setup() {
    ...
    const categoryData = computed(() => {
      ...
      // Use a single neutral color for all categories
      const singleColor = 'var(--text-secondary)' // Neutral secondary text color
...
.line-bar {
  ...
  cursor: pointer;
  box-shadow: 0 2px 4px rgba(251, 192, 14, 0.3);
}
