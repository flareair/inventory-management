            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <div class="info-value">
                  <span :style="{ color: inventoryItem.quantity_on_hand <= inventoryItem.reorder_point ? 'var(--error)' : 'var(--success)' }">
...
.item-icon.success-icon {
  background: linear-gradient(135deg, var(--success) 0%, #3FBF56 100%);
}

.item-icon.warning-icon {
  background: linear-gradient(135deg, var(--warning) 0%, var(--accent-yellow-active) 100%);
}

.item-icon.danger-icon {
  background: linear-gradient(135deg, var(--error) 0%, #C82612 100%);
}
...
.summary-card.primary {
  border-color: rgba(251, 192, 14, 0.4);
  background: rgba(251, 192, 14, 0.08);
}

.summary-card.success-card {
  border-color: rgba(85, 230, 111, 0.4);
  background: rgba(85, 230, 111, 0.08);
}
...
.summary-card.danger-card {
  border-color: rgba(240, 48, 22, 0.4);
